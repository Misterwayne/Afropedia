#!/usr/bin/env python3
"""
Reset database with admin account and Afropedia project article
"""
import asyncio
import os
import sys
...
async def reset_database():
    ...
    try:
        ...
        admin_data = {
            ...
            "password": "admin123",  # Store plain password, let auth system hash it
            "role": "admin",
            "is_active": True,
...
*This article serves as the central documentation for the Afropedia project. It will be updated as the platform evolves and grows.*""",
        ...
        # 4. Create a sample book about African history
